...
ungroup() %>% 
  ...
  group_by(PLACE_ST_NM, region, majority_minority, wave) %>%
  ...
  ggplot(aes(wave, percent, group = majority_minority)) +
  geom_line(aes(color=majority_minority)) + 
  geom_point(aes(color=majority_minority)) +
